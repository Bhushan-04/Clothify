...
import manimg1 from '../../../assets/products/HKBurgundy 1.webp';
import manimg2 from '../../../assets/products/HKBurgundy 2.webp';
import manimg3 from '../../../assets/products/HKBurgundy 3.webp';
import manimg4 from '../../../assets/products/HKBurgundy 4.webp';
                            ...
                            <div className='row'>
                                <div className='col-md-6'>
                                    <div className='img-holder' data-bs-toggle="modal" data-bs-target="#productModal">
                                        <img src={manimg1} className='img-tshirt mb-2' alt='' />
                                    </div>
                                </div>
                                <div className='col-md-6'>
                                    <div className='img-holder' data-bs-toggle="modal" data-bs-target="#productModal">
                                        <img src={manimg2} className='img-tshirt mb-2' alt='' />
                                    </div>
                                </div>
                                <div className='col-md-6'>
                                    <div className='img-holder' data-bs-toggle="modal" data-bs-target="#productModal">
                                        <img src={manimg3} className='img-tshirt mb-2' alt='' />
                                    </div>
                                </div>
                                <div className='col-md-6'>
                                    <div className='img-holder' data-bs-toggle="modal" data-bs-target="#productModal">
                                        <img src={manimg4} className='img-tshirt mb-2' alt='' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <section className='select-shirt'>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='row mt-3'>
                                        <div className='col-md-12 '>
                                            {/* <div className="select-product-div mt-4">
                                ...
                                <div className="d-flex add-cart-box">
                                    ...
                                    <button className="add btn">+</button>
                                            ...
                                            <div className='d-flex addcart-btn-sec mb-4'>
                                                <button className='btn btn-success me-2' onClick={() => navigate("/cart")}>Add to cart</button>
                                                <button className='btn btn-success me-2' onClick={() => navigate("/wishlist")}>Wishlist</button>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <img src={manimg1} className=" banner1-img me-2" alt="..." />
                                    <img src={manimg2} className="  banner1-img me-2" alt="..." />
                                    <img src={manimg3} className="  banner1-img me-2" alt="..." />
                                    <img src={manimg4} className="  banner1-img me-2" alt="..." />
                                    ...
                                    >
                                        <SwiperSlide>
                                            <div class=" banner-slider ">
                                                <img src={manimg1} class=" w-100 " alt="..." />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div class=" banner-slider ">
                                                <img src={manimg2} class=" w-100 " alt="..." />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div class=" banner-slider ">
                                                <img src={manimg3} class=" w-100 " alt="..." />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div class=" banner-slider ">
                                                <img src={manimg4} class=" w-100 " alt="..." />
                                            </div>
                                        </SwiperSlide>
                                    </Swiper>
                                </div>
...
export default ProductDetailsMan